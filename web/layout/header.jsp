                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="shop-menu pull-right">
                                                        <ul class="nav navbar-nav">
                                                            <li><a href="Profile"><i class="fa fa-user"></i> Account</a>
                                                            </li>
                                                            <li><a href="cartdetail"><i class="fa fa-shopping-cart"></i>
                                                                    Cart</a></li>
                                                            <c:if test="${userSession != null}">
                                                                <li><a href="Logout"><i class="fa fa-lock"></i>
                                                                        Logout</a></li>
                                                            </c:if>
                                                            <c:if test="${userSession == null}">
                                                                <li><a href="Login"><i class="fa fa-lock"></i> Login</a>
                                                                </li>
                                                            </c:if>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="mainmenu pull-left">
                                                        <ul class="nav navbar-nav collapse navbar-collapse">
                                                            ...
                                                            <c:if test="${not empty userSession}">
                                                                <c:if test="${userSession.setting.id == 1}">
                                                                    <li>
                                                                        <a href="admin/dashboard">Admin</a>
                                                                    </li>
                                                                </c:if>
                                                                <c:if test="${userSession.setting.id == 5}">
                                                                    <li>
                                                                        <a href="marketing/dashboard">Marketing</a>
                                                                    </li>
                                                                </c:if>
                                                                <c:if
                                                                    test="${userSession.setting.id == 3 || userSession.setting.id == 2}">
                                                                    <li>
