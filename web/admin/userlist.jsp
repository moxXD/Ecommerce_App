<%-- 
    Document   : userlist
    Created on : Apr 11, 2024, 5:10:43 PM
    Author     : Duc Le
--%>
                ...
                <section class="content">
                    ...
                    <div class="table-responsive">
                        <table class="table user-table">
                            <thead>
                                <tr>
                                    <th>ID <a href="userlist?page=${currentPage}&sort=id&order=${not sortOrder}"><i class="${sortIcon}"></i></a></th>
                                    <th>Full Name  <a href="userlist?page=${currentPage}&sort=fullname&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Gender  <a href="userlist?page=${currentPage}&sort=gender&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Email  <a href="userlist?page=${currentPage}&sort=email&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Mobile  <a href="userlist?page=${currentPage}&sort=phone&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Role  <a href="userlist?page=${currentPage}&sort=roleid&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Status  <a href="userlist?page=${currentPage}&sort=status&order=${not sortOrder}"><i class="${sortIcon}"></th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <c:if test="${currentPage > 1}">
                                    <li>
                                        <a href="userlist?page=${currentPage - 1}" aria-label="Previous">
                                            <span aria-hidden="true"><i class="fa fa-arrow-left"></i></a></span>
                                        </a>
                                    </li>
                                </c:if>
                                ...
                                <c:if test="${currentPage < noOfPage}">
                                    <li>
                                        <a href="userlist?page=${currentPage + 1}" aria-label="Next">
