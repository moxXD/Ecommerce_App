...
<html>
    ...
    <body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <button type="button"
                                    ...
                                    >Submit</button>
                            <button id="loadingButton" id="loadingButton" class="btn btn-primary btn-block " style="display: none" disabled>
                                Loading..
                            </button>
        ...
        <script type="text/javascript">
            ...
            window.location.href = 'cartcompletion?orderID=' + response;
