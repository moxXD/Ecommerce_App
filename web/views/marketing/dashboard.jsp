<%-- Document : dashboard Created on : Apr 23, 2024, 7:56:44 PM Author : Admin --%>
                                                ...
                                                <div class="col-lg-4">
                                                    <section class="panel">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="productdatepick"
                                                                    class="form-check-label">Select Date: </label>
                                                                <input type="date" name="productdatepick"
                                                                    class="form-control" id="productdatepick" value=""
                                                                    max="<%=java.time.LocalDate.now()%>"
                                                                    onchange="submitForm('productdatepick')">
                                                                <script>
                                                            ...
                                                            <div class="filter-row">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="filproductcate">Filter by Product
                                                                        Category:</label>
                                                                    <select name="filproductcate" id="filproductcate"
                                                                        class="form-control"
                                                                        ...
                                                                        <c:forEach items="${requestScope.settingList}"
                                                                            var="m">
                                                                            <c:if
                                                                                test="${m.type.equals('product category')}">
                                                                                <option value="${m.id}"
                                                                                    ${param.filproductcate==m.id?"selected":""}>
                                                                                    ${m.value}</option>
                                                                            </c:if>
                                                                        </c:forEach>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="filbrand" id="filbrand"
                                                                        class="form-control"
                                                                        onchange="submitForm('filbrand')">
                                                                        <option value="">All Brand </option>
                                                                        <c:forEach items="${requestScope.settingList}"
                                                                            var="n">
                                                                            <c:if test="${n.type.equals('brand')}">
                                                                                <option value="${n.id}"
                                                                                    ${param.filbrand==n.id?"selected":""}>
                                                                                    ${n.value}</option>
                                                                            </c:if>
                                                                        </c:forEach>
                                                                    </select>
                                                    ...
                                                    <div class="panel">
                                                            ...
                                                            <li class="list-group-item">
                                                                <c:choose>
                                                                    <c:when test="${empty x.imgUrl}">
                                                                        <a href="editproduct?id=${x.id}"><img
                                                                                id="img-preview"
                                                                ...
                                                                <c:if test="${fn:length(x.name) > 50}">
                                                                    <c:set var="subTitle"
                                                                        value="${fn:substring(x.name, 0, 50)}" />
                                                        ...
                                                        <div class="panel-footer bg-white">
                                                            ...
                                                            <a class="btn btn-primary btn-md" href="addproduct"
                                                                role="button">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <section class="panel">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="form-group">
                                                                <label for="postdatepick"
                                                                    class="form-check-label">Select Date: </label>
                                                                <input type="date" name="postdatepick"
                                                                    class="form-control" id="postdatepick" value=""
                                                                    max="<%=java.time.LocalDate.now()%>"
                                                                    onchange="submitForm('postdatepick')">
                                                                <script>
                                                                    document.addEventListener('DOMContentLoaded', function () {
                                                            ...
                                                            <div class="filter-row">
                                                                <!--category select-->
                                                                <div class="form-group">
                                                                    <label for="filcate">Filter by Blog
                                                                        Category:</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="filauthor" id="filauthor"
                                                                        class="form-control"
                                                                        onchange="submitForm('filauthor')">
                                                                        <option value="">All Author </option>
                                                                        <c:forEach items="${requestScope.blogAuthors}"
                                                                            var="s">
                                                                            <option value="${s.id}"
                                                                                ${param.filauthor==s.id?"selected":""}>
                                                                                ${s.fullname}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="panel">
                                                            ...
                                                            <li class="list-group-item">
                                                                <c:choose>
                                                                    <c:when test="${empty u.imgUrl}">
                                                                        <a href="blogdetail?action=update&ID=${u.id}"><img
                                                                                id="img-preview"
                                                                                src="${pageContext.request.contextPath}/images/blog/images1.jpg"
                                                                                alt="Thumbnail"
                                                                                class="img-fluid rounded-circle"
                                                        ...
                                                        <div class="panel-footer bg-white">
                                                            ...
                                                            <a class="btn btn-primary btn-md"
                                                                href="blogdetail?action=add" role="button">
                                                                <i class="fa fa-plus"></i>
                                                                Add New Post
                                                            </a>
                                                        </div>
