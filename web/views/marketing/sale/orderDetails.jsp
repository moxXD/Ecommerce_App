        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="userlist">
                                <i class="fa fa-users"></i> <span>Order Detail</span>
                            </a>
                        </li>
                        <li>
                            <a href="settinglist">
            ...
            <aside class="right-side">
                <section class="content">
                    <div class="container" >
                        <div class="row ">
                            <form method="POST" action="editorderdetail">
                                <div class="col">
                                    <div class="col-sm-12">
...
<!--                                                    <div class="form-group" style="${param.action.equals("add") ? "display: none;": "" }">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputLabel1">Order Date:</label>
                                                        <input readonly name="name" type="text" class="form-control"  value="${detail.create_at}" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputLabel1">Full Name: </label>
                                                        <input readonly name="description" type="text" class="form-control"  value="${detail.fullname}" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputLabel1">Address: </label>
                                                        <input name="address" type="text" class="form-control" value="${detail.address}" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputLabel1">Email: </label>
                                                        <input readonly name="url" type="text" class="form-control" value="${detail.email}" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputLabel1">Phone: </label>
                                                        <input readonly name="url" type="text" class="form-control" value="${detail.mobile}" >
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row form-check-inline">
                                                            <select name="status">
                                                                <option ${detail.status == "submitted" ? "selected" : ""}>submitted</option>
                                                                <option ${detail.status == "confirm" ? "selected" : ""}>confirm</option>
                                                                <option ${detail.status == "paid" ? "selected" : ""}>paid</option>
                                                                <option ${detail.status == "delivery" ? "selected" : ""}>delivery</option>
                                                                <option ${detail.status == "successful" ? "selected" : ""}>successful</option>
                                                                <option ${detail.status == "cancel" ? "selected" : ""}>cancel</option>
                                                            </select>
                                                        </div>
